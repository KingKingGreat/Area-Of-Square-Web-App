...
function onButtonClick() {
	...
	if (!length) {
		...
		// Display Question
		document.getElementById("rText").innerHTML = "Question : " + length + " length" + " * " + length + " length" + " = ? Area" + "<br>"; 
		// Display Result
		document.getElementById("rText").innerHTML += "Result : " + (length * length);  
	}
}
...
// Display Version
var d = new Date();
document.getElementById("version").innerHTML = "<strong>Version 1.0.2019521.111401.LM</strong><br>© " + d.getFullYear() + " KingKingGreat";
